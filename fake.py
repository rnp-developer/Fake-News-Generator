...
# actions = [
#     "stole 500 coconuts",
#     "declared himself the king of the colony",
#     "opened a tea stall on the moon",
#     "got stuck in a washing machine for 2 hours",
#     "started a new religion based on potatoes",
#     "tried to marry a robot",
#     "danced on the roof for 10 hours",
#     "painted all street dogs pink",
#     "fought with a mirror thinking it was a ghost",
#     "banned Monday in his village"
# ]
...
#     "Sector 13, Noida",
#     "Moon Market, Lahore",
#     "Under the flyover near Andheri",
#     "A haunted dhaba in Rajasthan",
#     "Cyber Café, Lajpat Nagar",
#     "Middle of Yamuna River",
#     "A local marriage hall in Bihar",
...
#     ans = f"\nBREAKING NEWS: {name} {action} at {place} {reaction}!"
#     print(ans)
#     # print(timestamp)
